 ...
 * Alter the program to use a for loop to print a tax table of annual income, tax rate, and tax to pay. 
 * Use starting and ending annual salaries of 40000 and 60000, respectively, and a salary increment of 5000.
