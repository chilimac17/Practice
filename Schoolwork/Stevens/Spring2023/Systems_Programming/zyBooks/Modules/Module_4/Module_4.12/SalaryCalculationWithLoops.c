 ...
 * For each annual salary, the program determines the tax rate and computes the tax to pay.
 * Run the program below with annual salaries of 40000, 90000, and then 0.
 * Modify the program to use a while loop inside the given while loop. 
 * The new inner loop should repeatedly ask the user to enter a salary deduction, stopping when the user enters a 0 or less. 
 * The deductions are summed and then subtracted from the annual income, giving an adjusted gross income. 
