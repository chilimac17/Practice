...
int main(void) {
    ...
    /**
     * @brief 
     * A core generic top-level domain (core gTLD) name is one of the following Internet domains: .com, .net, .org, and .info (ICANN: gTLDs). 
     * The following program asks the user to input a name and prints whether that name is a gTLD. The program uses the strcmp() function, 
     * which returns zero if the two compared strings are identical.
