package ProjectBundle1.StatsLib;
...
public class StatsLib {
    ...
    */
    ...
    /*
        ...
        except it does not take the squre root of the final answer and will 
        return the variance
        steps as followed:
        -gets mean of a list
        -subtracts the mean from every value in the list
    ...
    */
    ...
    /*
        ...
        basically this method will call it self until it gets to the base case which is when 
        num = 0 
    */
    ...
    /*
        ...
        it follows the formula:
            ...
            (r)!*(n-r)!
    */
	public int findCombinationProb(int n,int r){
		int answer = 0;
    ...
    /*
        ...
        it follows the formula:
            ...
            (n-r)!
    */
	public int findPermutationProb(int n, int r){
		int answer = 0;
    ...
    */
    ...
    /*
        ...
        it will be used for testing the union, intersection,
        and compliment methods above
    */
